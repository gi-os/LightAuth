package com.gios.lightauth.ui.theme
...
@Composable
fun LightAuthTheme(content: @Composable () -> Unit) {
    val fam = remember { akkuratFamilyOrDefault() }
    val type = Typography(
        // The code itself: tracked out wide, because six digits read as three pairs
        // and the gaps are what stop a transcription slip.
        displaySmall = TextStyle(
            fontFamily = fam, fontSize = 46.sp, fontWeight = FontWeight.Light,
            letterSpacing = 3.sp,
        ),
